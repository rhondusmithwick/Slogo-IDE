...
public abstract class SubBar {
     ...
     */
    protected SubBar(ObjectObservable<String> language, ObjectObservable<String> internalCommand,
     ...
     */
    protected Button makeButton(String key, EventHandler<ActionEvent> handler) {
