...
public class View implements ViewInt {
	...
	public View(GlobalProperties globalProperties, Dimension2D turtleDispDimension, Slogo slogo,
			ObservableMap<Integer, Turtle> turtles) {
		this.slogo = slogo;
	...
	private void createLeftPane() {
		...
		DefinedObjectsDisplay variableDisplay = new VariableDisplay(globalProperties, internalCommand, variables,
				error);
		left.getChildren().add(variableDisplay.getEnvDisplay());
		DefinedObjectsDisplay methodsDisplay = new MethodDisplay(globalProperties, internalCommand, definedCommands,
				error);
	...
	private void createToolBar() {
		...
		SubBar topBar = new TopBar(globalProperties, turtleIDs, internalCommand, selectedTurtle, error, allTurtles);
